<?php
    ...
    class PDF extends FPDF{
        ...
        function Header()
        {
            ...
            $this->Cell(70);
            // Title
            $this->Cell(50,8,'Customer List',0,0,'C');
            // Line break
            $this->Ln(30);
        }
    ...
    /*******========All orders Start================= */
        function tableheader(){
            ...
            $this->Cell(45,10,'Eamil',1,0,'C');
            $this->Cell(45,10,'Address',1,0,'C');
            $this->Cell(30,10,'Join Date',1,0,'C');
            $this->Ln();
        }
        function tableView($db,$fm){
            ...
            while($data = $result->fetch_assoc()){
                ...
                $this->Cell(17,10,$data['phoneNo'],1,0,'C');
                $this->Cell(45,10,$data['emai'],1,0,'C');
                $x = $this->GetX();
                $this-> Mycell(45,10,$x,$data['address']);
                $this->Cell(30,10,$data['joinDate'],1,0,'C');
                $this->Ln();
            }
